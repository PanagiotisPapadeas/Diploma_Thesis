...
#dependency2_forVisual.yaml
while True:
    f1 = input("Enter open api (.yaml) file:\n")
    #print(f1)
    try:        
        with open('files/'+f1, 'r') as file3:
            # read a list of lines into data
                    ...
                    if ('type:' in k):
                        ...
                        if (lmao in res_key and id in res_key[lmao]):
                            ...
                            if res_dep[lmao] not in compset:
                                ...
                                # tempstr = ''
                                # tempset = set()
                                # for i in res_key[lmao]:
                                #     #print(i)
                                #     tempset.add(i)
                                #     tempstr = tempstr+'_'+i
                                # for j in req_key[lmao]:
                                #     #print(j)
                                #     if j not in tempset:
                                #         tempstr = tempstr+'_'+j
                                # print('\n\n\n')
